#xbox_contoller.py modded RN V2
import pygame
...
class XBoxController:
    def __init__(self, command_freq, only_head_control=False):
        ...
        self.dpad_up_right_pressed = False
        self.dpad_up_left_pressed = False
        self.dpad_down_right_pressed = False
        self.dpad_down_left_pressed = False
        self.lcd_bus_clear = False
    ...
    def get_commands(self):
        ...
        for event in pygame.event.get():                # Button Map
            if event.type == pygame.JOYBUTTONDOWN:
                ...
                if self.p1.get_button(4):  # Y button walk/head control switch
                    self.Y_pressed = True
                ...
                if self.p1.get_button(10):  # Back button
                    self.back_pressed = True
                    print ("Back Button pressed")
                    
                if self.p1.get_button(11):  # Start button
                    self.start_pressed = True
                    print ("Start Button pressed")
                    
                if self.p1.get_button(13):  # LSB button
                    self.LSB_pressed = True
                    print ("LSB Button pressed")
                    
                if self.p1.get_button(14):  # RSB button
                    self.RSB_pressed = True
                    print ("RSB Button pressed")
                    
                if self.p1.get_button(15):  # GUID button
                    self.guide_pressed = True
                    print ("GUIDE Button pressed")
                    
            if event.type == pygame.JOYHATMOTION:
                if  self.p1.get_hat(0)[1] :             # Dpad Up and Down
                    value = self.p1.get_hat(0)[1] 
                    if value >= 1 :
                        print ("Dpad UP") 
                ...
                if self.p1.get_hat(0)[0] :             # Dpad Left and Right
                    value = self.p1.get_hat(0)[0]
                    if value >= 1:
                        print ("Dpad Right")
                ...
                if self.dpad_up_pressed and self.dpad_right_pressed:
                    print("Dpad NE")
                    self.dpad_up_pressed = False
                    self.dpad_right_pressed =False
                    self.dpad_up_right_pressed = True
                if self.dpad_up_pressed and self.dpad_left_pressed:
                    print("Dpad NW")
                    self.dpad_up_pressed = False
                    self.dpad_left_pressed =False
                    self.dpad_up_left_pressed = True
                if self.dpad_down_pressed and self.dpad_right_pressed:
                    print("Dpad SE")
                    self.dpad_down_pressed = False
                    self.dpad_right_pressed =False
                    self.dpad_down_right_pressed = True
                if self.dpad_down_pressed and self.dpad_left_pressed:
                    print ("Dpad SW")
                    self.dpad_down_pressed = False
                    self.dpad_left_pressed =False
                    self.dpad_down_left_pressed = True
                if  (not self.p1.get_hat(0)[1]) and (not self.p1.get_hat(0)[0]) :             # dpad clear(/up)
                    print("Dpad Clear")
                    self.dpad_up_pressed = False
                    self.dpad_down_pressed = False
                    self.dpad_left_pressed = False
            ...
            if left_trigger :           # Display left trigger button
                print (f"left trigger")

            if right_trigger :          # Display right trigger button
                print (f"right trigger")

            #for i in range(16):         #--------- org test routine to see buttons
